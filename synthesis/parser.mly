...
%token INT_SYM ASSERT_ZERO
%token<int> INT REG HOLE
...
| CONST REG COMMA HOLE { I_const (`L_Reg $2, `L_Hole $4) }
...
| INT_SYM REG COMMA ID { I_int_sym (`L_Reg $2, $4) }
| ASSERT_ZERO REG { I_assert_zero (`L_Reg $2) }*/
