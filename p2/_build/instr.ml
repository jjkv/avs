(* 
  9 step design process for find_queens
  forms
    square
    list(square)
    nats
    ...
    contract for find_queens

    focus on interesting law

    handout:
      case analysis using algebraic laws
      provide unit tests
      answer: 'SUCCESS
...
type value = [ `L_Int of int | `L_Str of string | `L_Id of string | `L_Loc of int | `L_Tab of (value,value) Hashtbl.t]
