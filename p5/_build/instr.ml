...
type value = [ `L_Int of int | `L_Str of string | `L_Id of string | (* `L_Loc of int | *) `L_Sym of Bvec.bvec | `L_Hole of int ]
...
(*
  | I_halt of reg (* src *)
  | I_int_sym of reg * string (* dst, var name key *)
  | I_assert_zero of reg
*)
...
type config = (*heap * *) stack * Boolean.bexpr
